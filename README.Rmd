...
All core optimizations (QP solving, SVD, Kalman filtering) are implemented in C++ via RcppArmadillo, achieving **up to ~56x speedups** over pure-R implementations on typical problem sizes (see the Performance section).
...
SCM supports covariate-based matching following Abadie et al. (2010) §2.3.
...
SCM benchmark vs. the **Synth** package (Windows 11 / R 4.6.0 / GCC 14.2.0):
...
- Agarwal, A., Shi, C., & Wager, S. (2025). Synthetic interventions. *arXiv:2006.07691*.
